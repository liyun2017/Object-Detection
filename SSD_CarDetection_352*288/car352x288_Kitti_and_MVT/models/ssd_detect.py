...
def parse_args():
    ...
    parser.add_argument('--model_weights',
                        default='/media/ly/data/CarData/car352x288_splitKitti_MVT_indoor/models/Kitti_and_MVT/car352x288_splitKitti_MVT_indoorSSD_352x288_iter_150000.caffemodel')
