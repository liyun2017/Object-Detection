...
class CaffeDetection:
    ...
    def detect(self, image_input, conf_thresh=0.5, topn=5):
        '''
        SSD detection
        '''
...
def image_process(args):
    save_path = "/media/ly/data/CarData/car352x288_split_KITTI/models/result/"
...
def parse_args():
    ...
    parser.add_argument('--labelmap_file',
                        default='/media/ly/data/CarData/car352x288_split_KITTI/models/labelmap_voc.prototxt')
    parser.add_argument('--model_def',
                        default='/media/ly/data/CarData/car352x288_split_KITTI/models/deploy.prototxt')
    parser.add_argument('--image_resize', default=(288,352), type=int)
    parser.add_argument('--model_weights',
                        default='/media/ly/data/CarData/car352x288_split_KITTI/models/car352x288_split_KITTISSD_352x288_iter_50000.caffemodel')
