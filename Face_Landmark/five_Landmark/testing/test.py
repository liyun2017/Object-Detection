...
caffe_model = '/media/ly/data/FacialLandmark_Caffe-master/training/net1/model/_iter_50000.caffemodel'
#deploy = sys.argv[2]
...
for idx, im_path in enumerate(os.listdir(img_folder)):
    ...
    out_path = im_path.replace('test_images', 'test_output_no_align1')
